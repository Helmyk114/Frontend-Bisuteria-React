...
import '../FormularioRegistroT/styleImgRegistroT.css';
    ...
    return (
     <div className='content'>
      <Card  className='card' style={{width: '40rem'}}>
          <div className='img'>
          {imageSrc ? (
            <img src={imageSrc} alt='Imagen seleccionada' style={{maxWidth:'100', maxHeight:'200px'}}  />
          ) : (
        ...
        <Card.Body className='body'>
         <input className='boton' type='file' onChange={handleImageChange}></input>
